...
public class ListAdapter extends ArrayAdapter {
    ...
    private static final int resource = R.layout.custom_listview_weather;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Log.d("cnt", String.valueOf(position));


        // カスタムビューの場合はViewが確実にあるtry-catch は不要ためか。
        TextView tv1 = (TextView) view.findViewById(R.id.currentWeather);
        TextView tv2 = (TextView) view.findViewById(R.id.currentTemp);
        TextView tv3 = (TextView) view.findViewById(R.id.currentPop);

        //List.xmlに表示する情報をセット
        tv1.setText(weatherday.day + "の天気\n"+weatherday.weather);
        tv2.setText("平均気温："+weatherday.temp+"℃");
        tv3.setText("降水確率："+weatherday.pop+"%");

        Log.d("日付21",weatherday.day);
