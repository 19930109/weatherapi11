...
public class DayAsyncHttpRequest extends AsyncTask<URL, Void, JSONObject> {
    private MainFragment mainFragment;
    private String cityname;
    private String id;

    public DayAsyncHttpRequest(MainFragment fragment, String id, String cityname) {
        // 呼び出し元のアクティビティ
    ...
    protected void onPostExecute(JSONObject result) {
        ...
        APIInsert_dayService insertService=new APIInsert_dayService();
        try {
